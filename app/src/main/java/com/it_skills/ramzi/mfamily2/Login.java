...
// Create a reference to "mountains.jpg"
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                String url="http://it-skills.tn/android/TwitterServer/Register.php?first_name="+name+"&email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString()+"&picture_path="+ downloadUrl;
...
//login
                    String url="http://it-skills.tn/android/TwitterServer/login.php?email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString() ;

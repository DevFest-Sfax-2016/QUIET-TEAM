package com.it_skills.ramzi.mfamily2;
...
//TODO: add code s=for subscribe and un subscribe
        ...
        String url="http://it-skills.tn/android/TwitterServer/UserFollowing.php?user_id="+SaveSettings.UserID +"&following_user_id="+SelectedUserID+"&op="+ Operation;
            ...
            if(s.tweet_date.equals("add")) {
                ...
                iv_post.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        String url="http://it-skills.tn/android/TwitterServer/TweetAdd.php?user_id="+ SaveSettings.UserID +"&tweet_text="+ tweets +"&tweet_picture="+ downloadUrl;
                        new  MyAsyncTaskgetNews().execute(url);
                        etPost.setText("");
                ...
                txtUserName.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        String url="http://it-skills.tn/android/TwitterServer/IsFollowing.php?user_id="+SaveSettings.UserID +"&following_user_id="+SelectedUserID;
                        new  MyAsyncTaskgetNews().execute(url);
    ...
    public void uploadimage(Bitmap bitmap ) {
        ...
        StorageReference storageRef = storage.getReferenceFromUrl("gs://faamily-79abc.appspot.com");
...
// Create a reference to "mountains.jpg"
    ...
    void LoadTweets(int StartFrom,int UserOperation){
        ...
        String url="http://it-skills.tn/android/TwitterServer/TweetList.php?user_id="+ SaveSettings.UserID + "&StartFrom="+StartFrom + "&op="+ UserOperation;
        if (UserOperation==SearchType.SearchIn)
            url="http://it-skills.tn/android/TwitterServer/TweetList.php?user_id="+ SaveSettings.UserID + "&StartFrom="+StartFrom + "&op="+ UserOperation + "&query="+ Searchquery;
        if(UserOperation==SearchType.OnePerson)
            url="http://it-skills.tn/android/TwitterServer/TweetList.php?user_id="+ SelectedUserID + "&StartFrom="+StartFrom + "&op="+ UserOperation;
